...
if(APP MATCHES "^(CSTLA|CSTLF|CSTLR|CSTLS|CSTLSW|CSTLW|CSTL-ALL)$")
  set(CMEPS      ON  CACHE BOOL "Enable CMEPS"               FORCE)
  set(CDEPS      ON  CACHE BOOL "Enable CDEPS"               FORCE)
